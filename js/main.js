...
function insertCue(tx, videoId, cue) {
    tx.executeSql('INSERT INTO cues (videoId, startTime, text) VALUES (?, ?, ?)', [videoId, cue.startTime, cue.text]);
}
...
db.transaction(function(tx) {
    ...
    tx.executeSql('CREATE TABLE IF NOT EXISTS cues (' +
        'videoId varchar(15), startTime varchar(15), endTime varchar(15), text varchar(255))', [], null, queryErrorHandler);
